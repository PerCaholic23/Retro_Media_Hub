            ...
            >
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center border border-gray-200 rounded-xl mt-2 w-fit">
                    <button 
  ...
  <div className="fixed bottom-0 left-0 w-full bg-white border-t px-24 py-5 flex justify-between items-center z-40 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
    ...
    <div className="flex items-center gap-8">
      ...
      <button
        ...
        className={`px-10 py-3 rounded-2xl font-bold transition-all transform active:scale-95 ${
          selectedItems.length === 0 
